...
void PFLocalization::calc_estimate() {
    ...
    for ( int i = 0; i < (int)particles_.size(); ++ i ) {
        //  esti_pos_[0] = esti_pos_[0] + particles_[i].x * particles_[i].weight;
        //  esti_pos_[1] = esti_pos_[1] + particles_[i].y * particles_[i].weight;
    }
  
    // esti_pos_[0] = esti_pos_[0]/particles_.size();
    // esti_pos_[1] = esti_pos_[1]/particles_.size();
